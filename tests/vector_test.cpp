...
//		ci = ci;  // works fine as expected
	...
	ft::vector<ft::vector<ft::list_node<int> > > ft_vec;


	ft::vector<ft::vector<std::string > > test_vector;

	ft::vector<std::string> test_str_vector;

	test_str_vector.push_back("Test");
	test_str_vector.push_back("Test1");

	test_vector.push_back(test_str_vector);

	ft::vector<std::string> test_str_vector_2;

	test_str_vector_2 = test_vector[0];

	std::cout<<test_str_vector_2[0]<<std::endl;
